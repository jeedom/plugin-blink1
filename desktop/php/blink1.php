            ...
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="mode">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="address"/>
                        </div>
                    </div>
                    <div class="form-group">
